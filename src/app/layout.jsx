...
export default function RootLayout({ children }) {
  return (
    <html lang="en" className={`${inter.variable} ${montserrat.variable}`}>
      <body className="bg-background dark:bg-background-dark text-text-primary dark:text-text-light">
        <ThemeProvider>
          ...
          <footer className="bg-white dark:bg-primary-900 border-t border-border-light dark:border-primary-800 py-8 mt-16">
            <div className="container mx-auto px-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    <li>
                      <a href="/builds" className="text-text-secondary dark:text-text-light/70 hover:text-primary-500 dark:hover:text-primary-400 transition-colors">
                        Build Guides
                      </a>
                    </li>
                    <li>
                      <a href="/monsters" className="text-text-secondary dark:text-text-light/70 hover:text-primary-500 dark:hover:text-primary-400 transition-colors">
                        Monster Database
                      </a>
                    </li>
                    <li>
                      <a href="/equipment/weapons" className="text-text-secondary dark:text-text-light/70 hover:text-primary-500 dark:hover:text-primary-400 transition-colors">
                        Weapons
                      </a>
                    </li>
                    <li>
                      <a href="/equipment/armor" className="text-text-secondary dark:text-text-light/70 hover:text-primary-500 dark:hover:text-primary-400 transition-colors">
                        Armor
                      </a>
                    </li>
                    <li>
                      <a href="/materials" className="text-text-secondary dark:text-text-light/70 hover:text-primary-500 dark:hover:text-primary-400 transition-colors">
                        Materials
                      </a>
                    </li>
                  </ul>
              ...
              <div className="mt-8 pt-4 border-t border-border-light dark:border-primary-800 text-center text-text-muted">
